...
export enum GenerateCommitMessageErrorEnum {
  ...
  outputTokensTooHigh = `Token limit exceeded, CMT_TOKENS_MAX_OUTPUT must not be much higher than the default ${DEFAULT_TOKEN_LIMITS.DEFAULT_MAX_TOKENS_OUTPUT} tokens.`
}
